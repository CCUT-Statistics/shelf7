...
function vip_add($uid,$num,$T)
{
    ...
    {   default: $day= $num*31;$day_text='month';break;
        case 'month': $day= $num*31;$day_text='month';break;
        case 'season': $day=$num*100;$day_text='season';break;
        case 'half_year': $day=$num*207;$day_text='half_year';break;
        case 'year':$day = $num*432;$day_text='year';break; }
    ...
    if(vip_isvip($uid)) {
        ...
        db_update('user_vip', array('uid' => $uid), array('end+' => $day * 86400));
                db_update('user_vip', array('uid' => $uid), array('grow+' => $T_grow));
    } else {
