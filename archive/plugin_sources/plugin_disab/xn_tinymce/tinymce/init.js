...
tinymce.init({
    ...
    plugins: ['advlist', 'anchor', 'autolink','autosave', 'autoresize', 'charmap', 'code', 'codesample', 'xiunoimgup','-directionality', 'fullscreen', 'help', 'image', 'importcss','insertdatetime', 'link', 'lists', 'media', 'nonbreaking','pagebreak', 'preview', 'quickbars', 'save', 'searchreplace', 'table', '-template',  '-visualblocks', '-visualchars', 'wordcount', 'emoticons', 'ttview'], // 加载的插件，-为禁用
    menu: {
    ...
    toolbar: [' code formatting fontcolor removeformat  alignment blockquote indentation list emoticons imgup link media codesample table  anchor hr toc preview  fullscreen restoredraft  help  ttview', t_external_toolbar.join(' ')], // 界面按钮
    // toolbar: ['fontfamily code | undo redo  | formatting fontcolor removeformat | alignment blockquote indentation list | imgup link media codesample table | anchor hr toc preview | fullscreen restoredraft | other', t_external_toolbar.join(' ')], // 界面按钮 备份
    toolbar_groups: { //按钮分组，节省空间，方便使用
        formatting: {
            icon: 'format',
            tooltip: '格式化',
            items: 'formatselect fontsize fontfamily | fontselect | fontsizeselect | bold italic underline strikethrough | superscript subscript'
        },
        alignment: {
            icon: 'align-left',
            tooltip: '对齐',
