...
try{
  ...
  $sql = "CREATE TABLE IF NOT EXISTS {$tablepre}autolink (
    ...
    `siteImg` varchar(255)  DEFAULT NULL COMMENT '站点LGO地址',
  ...
  db_create('autolink', array('uid'=>0, 'siteTitle'=>'菜鸟教程','siteUrl'=>'https://www.runoob.com','siteDesc'=>'学的不仅是技术，更是梦想！','create_time'=>time(),'status'=>1));
