...
<div class="card">
    <div class="card-header font-weight-bold">确定删除？</div>
    <div class="card-body ajax-body">
        <form action="<?php echo url("mod-delusers"); ?>" method="post" id="mod_delusers_form">
            <div class="form-group row">
                ...
                <div class="col-12 text-center">共删除 <span class="total font-weight-bold text-danger"></span> 个用户</div>
            </div>
            <div class="form-group row">
                <label class="col-4 form-control-label text-right"></label>
                <div class="col-8">
                    <button type="submit" class="btn btn-danger mr-2" data-loading-text="<?php echo lang('submiting'); ?>...">是，删除这些用户</button>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">否，关闭窗口</button>
                </div>
            </div>
        </form>
    </div>
