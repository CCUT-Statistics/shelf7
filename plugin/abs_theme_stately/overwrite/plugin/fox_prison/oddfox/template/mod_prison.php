        ...
        <form action="<?php echo url("mod-prison-{$puid}"); ?>" method="post" id="mod_prison_form">
            <div class="form-group row">
                <div class="col-sm-12">
                    ...
                    <div class="text-grey small mt-2">注：支持简单HTML格式，换行用<code>&lt;br&gt;</code></div>
                </div>
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend"><span class="input-group-text w-100">禁闭时长</span></div>
                <input type="number" class="form-control" placeholder="有效时间" name="endtime" value="1" id="endtime" minlength="1" maxlength="2" />
                <select name="timetype" id="timetype" class="form-select flex-grow-0 flex-shrink-1 w-fit">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-secondary" id="Close" data-bs-dismiss="modal">关闭窗口</button>
                </div>
            </div>
        </form>
    </div>
