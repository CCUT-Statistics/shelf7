...
var twemoji = function() {
	"use strict";
	var twemoji = {
		base: (location.protocol === "https:" ? "https:": "http:") + "//cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/",
		ext: ".png",
		size: "72x72",
		className: "emoji",
		convert: {
	...
	function parseNode(node, options) {
		...
		length = allText.length, attrib, attrname, modified, fragment, subnode, text, match, i, index, img, alt, icon, variant, src;
		while (length--) {
			modified = false;
