...
tinymce.init({
    selector: '#message',
    content_css: 'plugin/till_theme_htmxtest/view/js/tinymce/style.css', // 编辑内容区附加css文件
    language_url: 'plugin/till_theme_htmxtest/view/js/tinymce/langs/zh_CN.js', // 本地化中文语言包
