...
function xn_mkdir($dir, $mod = NULL, $recusive = NULL) {
	...
	// PHP 8.1+ deprecates passing NULL to bool/int-typed internal params.
	if($mod === NULL && $recusive === NULL) {
		return mkdir($dir);
	}

	$mode = $mod === NULL ? 0777 : intval($mod);
	if($recusive === NULL) {
		return mkdir($dir, $mode);
	}

	return mkdir($dir, $mode, (bool)$recusive);
}
